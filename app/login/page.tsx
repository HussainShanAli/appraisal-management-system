    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold">PAWS Login</CardTitle>
          <CardDescription>Performance & Appraisal Workflow System</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 text-center text-sm text-gray-600">
            ...
            <p>HR Admin: hr@company.com / password123</p>
